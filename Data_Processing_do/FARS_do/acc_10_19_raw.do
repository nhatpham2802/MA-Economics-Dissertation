set more off
/* Create raw FARS_data for 10-19 */

clear all

* For loop to have useful data in FARS_data
	
	cd "$directory/ECON 6073/Raw_data/FARS data/FARS_10_19/Accident_10_19"
...
save "$directory/ECON 6073/Final_data/acc_10_19_raw.dta", replace
